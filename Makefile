...
xgen_gdl90:
	...
	go build $(BUILDINFO) -p 4 main/mpu9250.go main/ahrs.go main/gen_gdl90.go main/traffic.go main/gps.go main/network.go main/managementinterface.go main/sdr.go main/uibroadcast.go main/monotonic.go main/datalog.go main/equations.go
