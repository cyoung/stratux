...
func initGPSSerial() bool {
	...
	if isSirfIV {
		...
		// Enable 38400 baud: $PSRF100,1,38400,8,1,0*3D
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x30, 0x2C, 0x31, 0x2C, 0x33, 0x38, 0x34, 0x30, 0x30, 0x2C, 0x38, 0x2C, 0x31, 0x2C, 0x30, 0x2A, 0x33, 0x44, 0x0d, 0x0a})
		baudrate = 38400
		p.Close()
		...
		// Enable 5Hz: $PSRF103,00,6,00,0*23 (To switch back to 1Hz: $PSRF103,00,7,00,0*22)
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x33, 0x2C, 0x30, 0x30, 0x2C, 0x36, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x2A, 0x32, 0x33, 0x0d, 0x0a})

		// Enable GGA: $PSRF103,00,00,01,01*25
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x33, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x31, 0x2C, 0x30, 0x31, 0x2A, 0x32, 0x35, 0x0d, 0x0a})
		// Enable GSA: $PSRF103,02,00,01,01*27
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x33, 0x2C, 0x30, 0x32, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x31, 0x2C, 0x30, 0x31, 0x2A, 0x32, 0x37, 0x0d, 0x0a})
		// Enable RMC: $PSRF103,04,00,01,01*21
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x33, 0x2C, 0x30, 0x34, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x31, 0x2C, 0x30, 0x31, 0x2A, 0x32, 0x31, 0x0d, 0x0a})
		// Enable VTG: $PSRF103,05,00,01,01*20
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x33, 0x2C, 0x30, 0x35, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x31, 0x2C, 0x30, 0x31, 0x2A, 0x32, 0x30, 0x0d, 0x0a})
		// Disable GSV: $PSRF103,03,00,00,01*27
		p.Write([]byte{0x24, 0x50, 0x53, 0x52, 0x46, 0x31, 0x30, 0x33, 0x2C, 0x30, 0x33, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x30, 0x2C, 0x30, 0x31, 0x2A, 0x32, 0x37, 0x0d, 0x0a})
        } else {
