...
function SettingsCtrl($rootScope, $scope, $state, $http) {
	...
	var toggles = ['UAT_Enabled', 'ES_Enabled', 'GPS_Enabled', 'AHRS_Enabled', 'DEBUG', 'VerboseLogs', 'ReplayLog', 'ForeFlightSimMode', 'DemoMode', 'FLARMTraffic', 'GPSAttitude_Enabled', 'UseOwnshipBaroAlt']; // DEBUG is 'DspTrafficSrc'
	var settings = {};
